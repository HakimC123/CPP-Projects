...
class VDetect{
    ...
    ******************************************/
    int findCurrent(Virus find) const;  //Helper function to find object in the current hash table
    int findOld(Virus find) const; //Helper function to find object in the old hash table
    void rehash(bool checkFactor); //Helper function to do our rehashing
    bool insertHelper(Virus virus); //Helper function to insert the object into the table
    bool removeHelper(Virus virus); //Helper function to remove object from the table
